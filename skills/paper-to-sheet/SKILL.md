...
- For uploaded photos/scans, prefer one full-photo JPEG no larger than 1500px on either side and show localized regions with a `#spark-bbox=left,top,right,bottom` fragment in source-image pixel coordinates, for example `[![Figure 1](grader/uploads/photo.jpg#spark-bbox=120,240,960,700)](grader/uploads/photo.jpg)`. This lets several figures reuse the same downloaded image while the click target opens the original photo.
