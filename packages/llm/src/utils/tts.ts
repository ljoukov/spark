...
import { googleTts, googleVoices, isGoogleVoice } from "./googleTTS";
import { isOpenAiVoice, openAiTts, openAiVoices } from "./openaiTTS";

export const voices = [...openAiVoices, ...googleVoices] as const;
