...
function buildProblemIdeasUserPrompt(
  ...
  return [
    ...
    "Avoid non-deterministic requirements. If the idea needs sampling/randomness, bake reproducibility into the blueprint (e.g., accept a seed/base list parameter or use a fixed witness set) so reference solutions and tests are stable.",
