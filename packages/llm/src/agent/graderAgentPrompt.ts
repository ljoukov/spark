...
export function buildSparkGraderAgentPrompt(options?: {
  ...
  return [
    ...
    "- The summary card now has four slots: title, subtitle, body summary markdown, and footer provenance.",
    ...
    `3) Write ${summaryPath} including a concise user-facing presentation title, subtitle, body summary markdown, and footer provenance derived from the uploaded content`,
