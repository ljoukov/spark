...
class UserAuthProto$Type extends MessageType<UserAuthProto> {
	...
	create(value?: PartialMessage<UserAuthProto>): UserAuthProto {
		...
		if (value !== undefined) reflectionMergePartial<UserAuthProto>(this, message, value);
		return message;
	}
	internalBinaryRead(
	...
	internalBinaryWrite(
		...
		/* string user_id = 1; */
		if (message.userId !== '') writer.tag(1, WireType.LengthDelimited).string(message.userId);
