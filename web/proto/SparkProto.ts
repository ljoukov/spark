...
class SparkApiRequestProto$Type extends MessageType<SparkApiRequestProto> {
    constructor() {
        super("SparkApiRequestProto", [
            ...
            { no: 10, name: "create", kind: "message", oneof: "request", T: () => SparkCreateRequestProto },
            { no: 11, name: "check_answer", kind: "message", oneof: "request", T: () => SparkCheckAnswerRequestProto }
        ]);
    }
    create(value?: PartialMessage<SparkApiRequestProto>): SparkApiRequestProto {
        ...
        if (value !== undefined)
            reflectionMergePartial<SparkApiRequestProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkApiRequestProto): SparkApiRequestProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* SparkRequestAuthProto request_auth */ 1:
                    message.requestAuth = SparkRequestAuthProto.internalBinaryRead(reader, reader.uint32(), options, message.requestAuth);
                    break;
                case /* SparkClientContextProto client_context */ 2:
                    message.clientContext = SparkClientContextProto.internalBinaryRead(reader, reader.uint32(), options, message.clientContext);
                    break;
                case /* SparkCreateRequestProto create */ 10:
                    message.request = {
                        oneofKind: "create",
                        create: SparkCreateRequestProto.internalBinaryRead(reader, reader.uint32(), options, (message.request as any).create)
                    };
                    break;
                case /* SparkCheckAnswerRequestProto check_answer */ 11:
                    message.request = {
                        oneofKind: "checkAnswer",
                        checkAnswer: SparkCheckAnswerRequestProto.internalBinaryRead(reader, reader.uint32(), options, (message.request as any).checkAnswer)
                    };
                    break;
                default:
    ...
    internalBinaryWrite(message: SparkApiRequestProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* SparkRequestAuthProto request_auth = 1; */
        if (message.requestAuth)
            SparkRequestAuthProto.internalBinaryWrite(message.requestAuth, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* SparkClientContextProto client_context = 2; */
        if (message.clientContext)
            SparkClientContextProto.internalBinaryWrite(message.clientContext, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* SparkCreateRequestProto create = 10; */
        if (message.request.oneofKind === "create")
            SparkCreateRequestProto.internalBinaryWrite(message.request.create, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
        /* SparkCheckAnswerRequestProto check_answer = 11; */
        if (message.request.oneofKind === "checkAnswer")
            SparkCheckAnswerRequestProto.internalBinaryWrite(message.request.checkAnswer, writer.tag(11, WireType.LengthDelimited).fork(), options).join();
...
class SparkApiResponseProto$Type extends MessageType<SparkApiResponseProto> {
    constructor() {
        super("SparkApiResponseProto", [
            ...
            { no: 10, name: "create", kind: "message", oneof: "response", T: () => SparkCreateResponseProto },
            { no: 11, name: "check_answer", kind: "message", oneof: "response", T: () => SparkCheckAnswerResponseProto },
    ...
    create(value?: PartialMessage<SparkApiResponseProto>): SparkApiResponseProto {
        ...
        message.latencies = {};
        if (value !== undefined)
            reflectionMergePartial<SparkApiResponseProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkApiResponseProto): SparkApiResponseProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* SparkApiErrorProto error */ 1:
                    message.error = SparkApiErrorProto.internalBinaryRead(reader, reader.uint32(), options, message.error);
                    break;
                case /* SparkCreateResponseProto create */ 10:
                    message.response = {
                        oneofKind: "create",
                        create: SparkCreateResponseProto.internalBinaryRead(reader, reader.uint32(), options, (message.response as any).create)
                    };
                    break;
                case /* SparkCheckAnswerResponseProto check_answer */ 11:
                    message.response = {
                        oneofKind: "checkAnswer",
                        checkAnswer: SparkCheckAnswerResponseProto.internalBinaryRead(reader, reader.uint32(), options, (message.response as any).checkAnswer)
                    };
                    break;
    ...
    private binaryReadMap100(map: SparkApiResponseProto["latencies"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof SparkApiResponseProto["latencies"] | undefined, val: SparkApiResponseProto["latencies"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for field SparkApiResponseProto.latencies");
            }
        }
        map[key ?? ""] = val ?? Duration.create();
    }
    internalBinaryWrite(message: SparkApiResponseProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* SparkApiErrorProto error = 1; */
        if (message.error)
            SparkApiErrorProto.internalBinaryWrite(message.error, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* SparkCreateResponseProto create = 10; */
        if (message.response.oneofKind === "create")
            SparkCreateResponseProto.internalBinaryWrite(message.response.create, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
        /* SparkCheckAnswerResponseProto check_answer = 11; */
        if (message.response.oneofKind === "checkAnswer")
            SparkCheckAnswerResponseProto.internalBinaryWrite(message.response.checkAnswer, writer.tag(11, WireType.LengthDelimited).fork(), options).join();
...
class SparkCreateRequestProto$Type extends MessageType<SparkCreateRequestProto> {
    ...
    create(value?: PartialMessage<SparkCreateRequestProto>): SparkCreateRequestProto {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<SparkCreateRequestProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkCreateRequestProto): SparkCreateRequestProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* SparkUploadReferenceProto upload */ 1:
                    message.upload = SparkUploadReferenceProto.internalBinaryRead(reader, reader.uint32(), options, message.upload);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: SparkCreateRequestProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* SparkUploadReferenceProto upload = 1; */
        if (message.upload)
            SparkUploadReferenceProto.internalBinaryWrite(message.upload, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkCreateResponseProto$Type extends MessageType<SparkCreateResponseProto> {
    ...
    create(value?: PartialMessage<SparkCreateResponseProto>): SparkCreateResponseProto {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<SparkCreateResponseProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkCreateResponseProto): SparkCreateResponseProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* SparkJobStatusProto job */ 1:
                    message.job = SparkJobStatusProto.internalBinaryRead(reader, reader.uint32(), options, message.job);
                    break;
                case /* SparkQuizProto quiz */ 2:
                    message.quiz = SparkQuizProto.internalBinaryRead(reader, reader.uint32(), options, message.quiz);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: SparkCreateResponseProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* SparkJobStatusProto job = 1; */
        if (message.job)
            SparkJobStatusProto.internalBinaryWrite(message.job, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* SparkQuizProto quiz = 2; */
        if (message.quiz)
            SparkQuizProto.internalBinaryWrite(message.quiz, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkUploadReferenceProto$Type extends MessageType<SparkUploadReferenceProto> {
    constructor() {
        super("SparkUploadReferenceProto", [
            ...
            { no: 2, name: "upload_type", kind: "enum", T: () => ["SparkUploadTypeProto", SparkUploadTypeProto, "SPARK_UPLOAD_TYPE_PROTO_"] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkUploadReferenceProto): SparkUploadReferenceProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* SparkPageRangeProto page_range */ 5:
                    message.pageRange = SparkPageRangeProto.internalBinaryRead(reader, reader.uint32(), options, message.pageRange);
                    break;
                case /* google.protobuf.Timestamp uploaded_at */ 6:
                    message.uploadedAt = Timestamp.internalBinaryRead(reader, reader.uint32(), options, message.uploadedAt);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: SparkUploadReferenceProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.uploadType !== 0)
            writer.tag(2, WireType.Varint).int32(message.uploadType);
        /* string mime_type = 3; */
        if (message.mimeType !== "")
        ...
        if (message.pageRange)
            SparkPageRangeProto.internalBinaryWrite(message.pageRange, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        /* google.protobuf.Timestamp uploaded_at = 6; */
        if (message.uploadedAt)
            Timestamp.internalBinaryWrite(message.uploadedAt, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkPageRangeProto$Type extends MessageType<SparkPageRangeProto> {
    ...
    create(value?: PartialMessage<SparkPageRangeProto>): SparkPageRangeProto {
        ...
        message.endPage = 0;
        if (value !== undefined)
            reflectionMergePartial<SparkPageRangeProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkPageRangeProto): SparkPageRangeProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SparkPageRangeProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* int32 start_page = 1; */
        if (message.startPage !== 0)
            writer.tag(1, WireType.Varint).int32(message.startPage);
        /* int32 end_page = 2; */
        if (message.endPage !== 0)
            writer.tag(2, WireType.Varint).int32(message.endPage);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkCheckAnswerRequestProto$Type extends MessageType<SparkCheckAnswerRequestProto> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkCheckAnswerRequestProto): SparkCheckAnswerRequestProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* SparkSubmittedAnswerProto answer */ 3:
                    message.answer = SparkSubmittedAnswerProto.internalBinaryRead(reader, reader.uint32(), options, message.answer);
                    break;
    ...
    internalBinaryWrite(message: SparkCheckAnswerRequestProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string quiz_id = 1; */
        if (message.quizId !== "")
        ...
        if (message.answer)
            SparkSubmittedAnswerProto.internalBinaryWrite(message.answer, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* string attempt_id = 4; */
        ...
        if (message.answeredAt)
            Timestamp.internalBinaryWrite(message.answeredAt, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkCheckAnswerResponseProto$Type extends MessageType<SparkCheckAnswerResponseProto> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkCheckAnswerResponseProto): SparkCheckAnswerResponseProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* SparkAnswerEvaluationProto evaluation */ 1:
                    message.evaluation = SparkAnswerEvaluationProto.internalBinaryRead(reader, reader.uint32(), options, message.evaluation);
                    break;
                case /* SparkQuestionProto question */ 2:
                    message.question = SparkQuestionProto.internalBinaryRead(reader, reader.uint32(), options, message.question);
                    break;
    ...
    internalBinaryWrite(message: SparkCheckAnswerResponseProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* SparkAnswerEvaluationProto evaluation = 1; */
        if (message.evaluation)
            SparkAnswerEvaluationProto.internalBinaryWrite(message.evaluation, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* SparkQuestionProto question = 2; */
        if (message.question)
            SparkQuestionProto.internalBinaryWrite(message.question, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* google.protobuf.Timestamp evaluated_at = 3; */
        if (message.evaluatedAt)
            Timestamp.internalBinaryWrite(message.evaluatedAt, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkSubmittedAnswerProto$Type extends MessageType<SparkSubmittedAnswerProto> {
    constructor() {
        super("SparkSubmittedAnswerProto", [
            ...
            { no: 4, name: "numeric", kind: "message", oneof: "value", T: () => SparkNumericSubmissionProto }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkSubmittedAnswerProto): SparkSubmittedAnswerProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* SparkNumericSubmissionProto numeric */ 4:
                    message.value = {
                        oneofKind: "numeric",
                        numeric: SparkNumericSubmissionProto.internalBinaryRead(reader, reader.uint32(), options, (message.value as any).numeric)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: SparkSubmittedAnswerProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string text = 1; */
        ...
        if (message.value.oneofKind === "numeric")
            SparkNumericSubmissionProto.internalBinaryWrite(message.value.numeric, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkNumericSubmissionProto$Type extends MessageType<SparkNumericSubmissionProto> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkNumericSubmissionProto): SparkNumericSubmissionProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SparkNumericSubmissionProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* double value = 1; */
        if (message.value !== 0)
...
class SparkAnswerEvaluationProto$Type extends MessageType<SparkAnswerEvaluationProto> {
    constructor() {
        super("SparkAnswerEvaluationProto", [
            { no: 1, name: "grade", kind: "enum", T: () => ["SparkAnswerGradeProto", SparkAnswerGradeProto, "SPARK_ANSWER_GRADE_PROTO_"] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkAnswerEvaluationProto): SparkAnswerEvaluationProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* google.protobuf.Timestamp retry_available_at */ 4:
                    message.retryAvailableAt = Timestamp.internalBinaryRead(reader, reader.uint32(), options, message.retryAvailableAt);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: SparkAnswerEvaluationProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* SparkAnswerGradeProto grade = 1; */
        if (message.grade !== 0)
            writer.tag(1, WireType.Varint).int32(message.grade);
        /* string feedback = 2; */
        if (message.feedback !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.feedback);
        /* double score = 3; */
        if (message.score !== 0)
        ...
        if (message.retryAvailableAt)
            Timestamp.internalBinaryWrite(message.retryAvailableAt, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkQuestionProto$Type extends MessageType<SparkQuestionProto> {
    constructor() {
        super("SparkQuestionProto", [
            ...
            { no: 2, name: "kind", kind: "enum", T: () => ["SparkQuestionKindProto", SparkQuestionKindProto, "SPARK_QUESTION_KIND_PROTO_"] },
            ...
            { no: 10, name: "multiple_choice", kind: "message", oneof: "body", T: () => SparkMultipleChoiceQuestionProto },
            { no: 11, name: "true_false", kind: "message", oneof: "body", T: () => SparkTrueFalseQuestionProto },
            { no: 12, name: "short_text", kind: "message", oneof: "body", T: () => SparkFreeTextQuestionProto },
            { no: 13, name: "numeric", kind: "message", oneof: "body", T: () => SparkNumericQuestionProto }
        ]);
    }
    create(value?: PartialMessage<SparkQuestionProto>): SparkQuestionProto {
        ...
        if (value !== undefined)
            reflectionMergePartial<SparkQuestionProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkQuestionProto): SparkQuestionProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* SparkQuestionSourceProto source */ 4:
                    message.source = SparkQuestionSourceProto.internalBinaryRead(reader, reader.uint32(), options, message.source);
                    break;
                case /* SparkQuestionAnswerKeyProto answer_key */ 5:
                    message.answerKey = SparkQuestionAnswerKeyProto.internalBinaryRead(reader, reader.uint32(), options, message.answerKey);
                    break;
                ...
                case /* SparkMultipleChoiceQuestionProto multiple_choice */ 10:
                    message.body = {
                        oneofKind: "multipleChoice",
                        multipleChoice: SparkMultipleChoiceQuestionProto.internalBinaryRead(reader, reader.uint32(), options, (message.body as any).multipleChoice)
                    };
                    break;
                case /* SparkTrueFalseQuestionProto true_false */ 11:
                    message.body = {
                        oneofKind: "trueFalse",
                        trueFalse: SparkTrueFalseQuestionProto.internalBinaryRead(reader, reader.uint32(), options, (message.body as any).trueFalse)
                    };
                    break;
                case /* SparkFreeTextQuestionProto short_text */ 12:
                    message.body = {
                        oneofKind: "shortText",
                        shortText: SparkFreeTextQuestionProto.internalBinaryRead(reader, reader.uint32(), options, (message.body as any).shortText)
                    };
                    break;
                case /* SparkNumericQuestionProto numeric */ 13:
                    message.body = {
                        oneofKind: "numeric",
                        numeric: SparkNumericQuestionProto.internalBinaryRead(reader, reader.uint32(), options, (message.body as any).numeric)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: SparkQuestionProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.source)
            SparkQuestionSourceProto.internalBinaryWrite(message.source, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        /* SparkQuestionAnswerKeyProto answer_key = 5; */
        if (message.answerKey)
            SparkQuestionAnswerKeyProto.internalBinaryWrite(message.answerKey, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        ...
        if (message.body.oneofKind === "multipleChoice")
            SparkMultipleChoiceQuestionProto.internalBinaryWrite(message.body.multipleChoice, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
        /* SparkTrueFalseQuestionProto true_false = 11; */
        if (message.body.oneofKind === "trueFalse")
            SparkTrueFalseQuestionProto.internalBinaryWrite(message.body.trueFalse, writer.tag(11, WireType.LengthDelimited).fork(), options).join();
        /* SparkFreeTextQuestionProto short_text = 12; */
        if (message.body.oneofKind === "shortText")
            SparkFreeTextQuestionProto.internalBinaryWrite(message.body.shortText, writer.tag(12, WireType.LengthDelimited).fork(), options).join();
        /* SparkNumericQuestionProto numeric = 13; */
        if (message.body.oneofKind === "numeric")
            SparkNumericQuestionProto.internalBinaryWrite(message.body.numeric, writer.tag(13, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkQuestionSourceProto$Type extends MessageType<SparkQuestionSourceProto> {
    ...
    create(value?: PartialMessage<SparkQuestionSourceProto>): SparkQuestionSourceProto {
        ...
        message.snippet = "";
        if (value !== undefined)
            reflectionMergePartial<SparkQuestionSourceProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkQuestionSourceProto): SparkQuestionSourceProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SparkQuestionSourceProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.pageRange)
            SparkPageRangeProto.internalBinaryWrite(message.pageRange, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* string snippet = 3; */
        if (message.snippet !== "")
...
class SparkQuestionAnswerKeyProto$Type extends MessageType<SparkQuestionAnswerKeyProto> {
    constructor() {
        super("SparkQuestionAnswerKeyProto", [
            { no: 1, name: "multiple_choice", kind: "message", oneof: "key", T: () => SparkMultipleChoiceAnswerKeyProto },
            { no: 2, name: "true_false", kind: "message", oneof: "key", T: () => SparkTrueFalseAnswerKeyProto },
            { no: 3, name: "short_text", kind: "message", oneof: "key", T: () => SparkFreeTextAnswerKeyProto },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkQuestionAnswerKeyProto): SparkQuestionAnswerKeyProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* SparkMultipleChoiceAnswerKeyProto multiple_choice */ 1:
                    message.key = {
                        oneofKind: "multipleChoice",
                        multipleChoice: SparkMultipleChoiceAnswerKeyProto.internalBinaryRead(reader, reader.uint32(), options, (message.key as any).multipleChoice)
                    };
                    break;
                case /* SparkTrueFalseAnswerKeyProto true_false */ 2:
                    message.key = {
                        oneofKind: "trueFalse",
                        trueFalse: SparkTrueFalseAnswerKeyProto.internalBinaryRead(reader, reader.uint32(), options, (message.key as any).trueFalse)
                    };
                    break;
                case /* SparkFreeTextAnswerKeyProto short_text */ 3:
                    message.key = {
                        oneofKind: "shortText",
                        shortText: SparkFreeTextAnswerKeyProto.internalBinaryRead(reader, reader.uint32(), options, (message.key as any).shortText)
                    };
                    break;
                case /* SparkNumericAnswerKeyProto numeric */ 4:
                    message.key = {
                        oneofKind: "numeric",
                        numeric: SparkNumericAnswerKeyProto.internalBinaryRead(reader, reader.uint32(), options, (message.key as any).numeric)
                    };
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: SparkQuestionAnswerKeyProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* SparkMultipleChoiceAnswerKeyProto multiple_choice = 1; */
        if (message.key.oneofKind === "multipleChoice")
            SparkMultipleChoiceAnswerKeyProto.internalBinaryWrite(message.key.multipleChoice, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* SparkTrueFalseAnswerKeyProto true_false = 2; */
        if (message.key.oneofKind === "trueFalse")
            SparkTrueFalseAnswerKeyProto.internalBinaryWrite(message.key.trueFalse, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* SparkFreeTextAnswerKeyProto short_text = 3; */
        if (message.key.oneofKind === "shortText")
            SparkFreeTextAnswerKeyProto.internalBinaryWrite(message.key.shortText, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* SparkNumericAnswerKeyProto numeric = 4; */
        if (message.key.oneofKind === "numeric")
            SparkNumericAnswerKeyProto.internalBinaryWrite(message.key.numeric, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkMultipleChoiceQuestionProto$Type extends MessageType<SparkMultipleChoiceQuestionProto> {
    constructor() {
        super("SparkMultipleChoiceQuestionProto", [
            { no: 1, name: "options", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => SparkMultipleChoiceOptionProto },
            { no: 2, name: "shuffle_options", kind: "scalar", T: 8 /*ScalarType.BOOL*/ }
        ]);
    }
    create(value?: PartialMessage<SparkMultipleChoiceQuestionProto>): SparkMultipleChoiceQuestionProto {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.options = [];
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkMultipleChoiceQuestionProto): SparkMultipleChoiceQuestionProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated SparkMultipleChoiceOptionProto options */ 1:
                    message.options.push(SparkMultipleChoiceOptionProto.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message: SparkMultipleChoiceQuestionProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated SparkMultipleChoiceOptionProto options = 1; */
        for (let i = 0; i < message.options.length; i++)
            SparkMultipleChoiceOptionProto.internalBinaryWrite(message.options[i], writer.tag(1, WireType.LengthDelimited).fork(), options).join();
...
class SparkMultipleChoiceOptionProto$Type extends MessageType<SparkMultipleChoiceOptionProto> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkMultipleChoiceOptionProto): SparkMultipleChoiceOptionProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SparkMultipleChoiceOptionProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string option_id = 1; */
        if (message.optionId !== "")
...
class SparkTrueFalseQuestionProto$Type extends MessageType<SparkTrueFalseQuestionProto> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkTrueFalseQuestionProto): SparkTrueFalseQuestionProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SparkTrueFalseQuestionProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string statement = 1; */
...
class SparkFreeTextQuestionProto$Type extends MessageType<SparkFreeTextQuestionProto> {
    constructor() {
        super("SparkFreeTextQuestionProto", [
            ...
            { no: 2, name: "key_points", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkFreeTextQuestionProto): SparkFreeTextQuestionProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* SparkFreeTextRubricProto rubric */ 1:
                    message.rubric = SparkFreeTextRubricProto.internalBinaryRead(reader, reader.uint32(), options, message.rubric);
                    break;
    ...
    internalBinaryWrite(message: SparkFreeTextQuestionProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* SparkFreeTextRubricProto rubric = 1; */
        if (message.rubric)
            SparkFreeTextRubricProto.internalBinaryWrite(message.rubric, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
...
class SparkFreeTextRubricProto$Type extends MessageType<SparkFreeTextRubricProto> {
    constructor() {
        super("SparkFreeTextRubricProto", [
            ...
            { no: 2, name: "bullet_points", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<SparkFreeTextRubricProto>): SparkFreeTextRubricProto {
        ...
        if (value !== undefined)
            reflectionMergePartial<SparkFreeTextRubricProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkFreeTextRubricProto): SparkFreeTextRubricProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SparkFreeTextRubricProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string overview = 1; */
        if (message.overview !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.overview);
...
class SparkNumericQuestionProto$Type extends MessageType<SparkNumericQuestionProto> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkNumericQuestionProto): SparkNumericQuestionProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* SparkNumericAnswerRuleProto rule */ 2:
                    message.rule = SparkNumericAnswerRuleProto.internalBinaryRead(reader, reader.uint32(), options, message.rule);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: SparkNumericQuestionProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.rule)
            SparkNumericAnswerRuleProto.internalBinaryWrite(message.rule, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkNumericAnswerRuleProto$Type extends MessageType<SparkNumericAnswerRuleProto> {
    constructor() {
        super("SparkNumericAnswerRuleProto", [
            { no: 1, name: "value", kind: "scalar", T: 1 /*ScalarType.DOUBLE*/ },
            { no: 2, name: "unit", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "tolerance_type", kind: "enum", T: () => ["SparkNumericToleranceTypeProto", SparkNumericToleranceTypeProto, "SPARK_NUMERIC_TOLERANCE_TYPE_PROTO_"] },
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkNumericAnswerRuleProto): SparkNumericAnswerRuleProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SparkNumericAnswerRuleProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* double value = 1; */
        if (message.value !== 0)
            writer.tag(1, WireType.Bit64).double(message.value);
        /* string unit = 2; */
        ...
        if (message.toleranceType !== 0)
            writer.tag(3, WireType.Varint).int32(message.toleranceType);
        /* double tolerance = 4; */
...
class SparkMultipleChoiceAnswerKeyProto$Type extends MessageType<SparkMultipleChoiceAnswerKeyProto> {
    ...
    create(value?: PartialMessage<SparkMultipleChoiceAnswerKeyProto>): SparkMultipleChoiceAnswerKeyProto {
        const message = globalThis.Object.create((this.messagePrototype!));
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkMultipleChoiceAnswerKeyProto): SparkMultipleChoiceAnswerKeyProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SparkMultipleChoiceAnswerKeyProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class SparkTrueFalseAnswerKeyProto$Type extends MessageType<SparkTrueFalseAnswerKeyProto> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkTrueFalseAnswerKeyProto): SparkTrueFalseAnswerKeyProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SparkTrueFalseAnswerKeyProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* bool correct_value = 1; */
        if (message.correctValue !== false)
            writer.tag(1, WireType.Varint).bool(message.correctValue);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkFreeTextAnswerKeyProto$Type extends MessageType<SparkFreeTextAnswerKeyProto> {
    constructor() {
        super("SparkFreeTextAnswerKeyProto", [
            { no: 1, name: "exemplar_answers", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkFreeTextAnswerKeyProto): SparkFreeTextAnswerKeyProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SparkFreeTextAnswerKeyProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class SparkNumericAnswerKeyProto$Type extends MessageType<SparkNumericAnswerKeyProto> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkNumericAnswerKeyProto): SparkNumericAnswerKeyProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* SparkNumericAnswerRuleProto expected */ 1:
                    message.expected = SparkNumericAnswerRuleProto.internalBinaryRead(reader, reader.uint32(), options, message.expected);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: SparkNumericAnswerKeyProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* SparkNumericAnswerRuleProto expected = 1; */
        if (message.expected)
            SparkNumericAnswerRuleProto.internalBinaryWrite(message.expected, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkQuizProto$Type extends MessageType<SparkQuizProto> {
    constructor() {
        super("SparkQuizProto", [
            ...
            { no: 3, name: "questions", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => SparkQuestionProto },
    ...
    create(value?: PartialMessage<SparkQuizProto>): SparkQuizProto {
        ...
        message.questions = [];
        if (value !== undefined)
            reflectionMergePartial<SparkQuizProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkQuizProto): SparkQuizProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* SparkQuizMetadataProto metadata */ 2:
                    message.metadata = SparkQuizMetadataProto.internalBinaryRead(reader, reader.uint32(), options, message.metadata);
                    break;
                case /* repeated SparkQuestionProto questions */ 3:
                    message.questions.push(SparkQuestionProto.internalBinaryRead(reader, reader.uint32(), options));
                    break;
    ...
    internalBinaryWrite(message: SparkQuizProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string quiz_id = 1; */
        if (message.quizId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.quizId);
        /* SparkQuizMetadataProto metadata = 2; */
        if (message.metadata)
            SparkQuizMetadataProto.internalBinaryWrite(message.metadata, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* repeated SparkQuestionProto questions = 3; */
        for (let i = 0; i < message.questions.length; i++)
            SparkQuestionProto.internalBinaryWrite(message.questions[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
...
class SparkQuizMetadataProto$Type extends MessageType<SparkQuizMetadataProto> {
    constructor() {
        super("SparkQuizMetadataProto", [
            { no: 1, name: "programme", kind: "enum", T: () => ["SparkProgrammeProto", SparkProgrammeProto, "SPARK_PROGRAMME_PROTO_"] },
            { no: 2, name: "subject", kind: "enum", T: () => ["SparkSubjectProto", SparkSubjectProto, "SPARK_SUBJECT_PROTO_"] },
            { no: 3, name: "exam_board", kind: "enum", T: () => ["SparkExamBoardProto", SparkExamBoardProto, "SPARK_EXAM_BOARD_PROTO_"] },
            { no: 4, name: "generation_mode", kind: "enum", T: () => ["SparkGenerationModeProto", SparkGenerationModeProto, "SPARK_GENERATION_MODE_PROTO_"] },
    ...
    create(value?: PartialMessage<SparkQuizMetadataProto>): SparkQuizMetadataProto {
        ...
        message.subtopic = "";
        if (value !== undefined)
            reflectionMergePartial<SparkQuizMetadataProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkQuizMetadataProto): SparkQuizMetadataProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SparkQuizMetadataProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* SparkProgrammeProto programme = 1; */
        if (message.programme !== 0)
            writer.tag(1, WireType.Varint).int32(message.programme);
        /* SparkSubjectProto subject = 2; */
        if (message.subject !== 0)
            writer.tag(2, WireType.Varint).int32(message.subject);
        /* SparkExamBoardProto exam_board = 3; */
        if (message.examBoard !== 0)
            writer.tag(3, WireType.Varint).int32(message.examBoard);
        /* SparkGenerationModeProto generation_mode = 4; */
        if (message.generationMode !== 0)
            writer.tag(4, WireType.Varint).int32(message.generationMode);
        /* int32 total_questions = 5; */
        if (message.totalQuestions !== 0)
            writer.tag(5, WireType.Varint).int32(message.totalQuestions);
        /* string topic = 6; */
        if (message.topic !== "")
            writer.tag(6, WireType.LengthDelimited).string(message.topic);
        /* string subtopic = 7; */
        if (message.subtopic !== "")
            writer.tag(7, WireType.LengthDelimited).string(message.subtopic);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkJobStatusProto$Type extends MessageType<SparkJobStatusProto> {
    constructor() {
        super("SparkJobStatusProto", [
            ...
            { no: 2, name: "state", kind: "enum", T: () => ["SparkJobStateProto", SparkJobStateProto, "SPARK_JOB_STATE_PROTO_"] },
    ...
    create(value?: PartialMessage<SparkJobStatusProto>): SparkJobStatusProto {
        ...
        if (value !== undefined)
            reflectionMergePartial<SparkJobStatusProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkJobStatusProto): SparkJobStatusProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* SparkJobErrorProto error */ 6:
                    message.error = SparkJobErrorProto.internalBinaryRead(reader, reader.uint32(), options, message.error);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: SparkJobStatusProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string job_id = 1; */
        if (message.jobId !== "")
        ...
        if (message.error)
            SparkJobErrorProto.internalBinaryWrite(message.error, writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkJobErrorProto$Type extends MessageType<SparkJobErrorProto> {
    ...
    create(value?: PartialMessage<SparkJobErrorProto>): SparkJobErrorProto {
        ...
        message.context = {};
        if (value !== undefined)
            reflectionMergePartial<SparkJobErrorProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkJobErrorProto): SparkJobErrorProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    private binaryReadMap3(map: SparkJobErrorProto["context"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof SparkJobErrorProto["context"] | undefined, val: SparkJobErrorProto["context"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for field SparkJobErrorProto.context");
            }
        }
        map[key ?? ""] = val ?? "";
    }
    internalBinaryWrite(message: SparkJobErrorProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string code = 1; */
        if (message.code !== "")
...
class SparkFirestoreDocProto$Type extends MessageType<SparkFirestoreDocProto> {
    ...
    create(value?: PartialMessage<SparkFirestoreDocProto>): SparkFirestoreDocProto {
        ...
        message.docId = "";
        if (value !== undefined)
            reflectionMergePartial<SparkFirestoreDocProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkFirestoreDocProto): SparkFirestoreDocProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* SparkQuizSummaryProto summary */ 5:
                    message.summary = SparkQuizSummaryProto.internalBinaryRead(reader, reader.uint32(), options, message.summary);
                    break;
    ...
    internalBinaryWrite(message: SparkFirestoreDocProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string doc_id = 1; */
        if (message.docId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.docId);
        /* SparkUploadReferenceProto upload = 2; */
        if (message.upload)
            SparkUploadReferenceProto.internalBinaryWrite(message.upload, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        /* SparkJobStatusProto job = 3; */
        if (message.job)
            SparkJobStatusProto.internalBinaryWrite(message.job, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* SparkQuizProto quiz = 4; */
        if (message.quiz)
            SparkQuizProto.internalBinaryWrite(message.quiz, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        /* SparkQuizSummaryProto summary = 5; */
        if (message.summary)
            SparkQuizSummaryProto.internalBinaryWrite(message.summary, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
...
class SparkFirestoreStateProto$Type extends MessageType<SparkFirestoreStateProto> {
    constructor() {
        super("SparkFirestoreStateProto", [
            { no: 1, name: "quiz_states", kind: "map", K: 9 /*ScalarType.STRING*/, V: { kind: "message", T: () => SparkQuizStateProto } },
    ...
    create(value?: PartialMessage<SparkFirestoreStateProto>): SparkFirestoreStateProto {
        ...
        message.quizStates = {};
        if (value !== undefined)
            reflectionMergePartial<SparkFirestoreStateProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkFirestoreStateProto): SparkFirestoreStateProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    private binaryReadMap1(map: SparkFirestoreStateProto["quizStates"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof SparkFirestoreStateProto["quizStates"] | undefined, val: SparkFirestoreStateProto["quizStates"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for field SparkFirestoreStateProto.quiz_states");
            }
        }
        map[key ?? ""] = val ?? SparkQuizStateProto.create();
    }
    internalBinaryWrite(message: SparkFirestoreStateProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class SparkQuizStateProto$Type extends MessageType<SparkQuizStateProto> {
    constructor() {
        super("SparkQuizStateProto", [
            ...
            { no: 7, name: "status", kind: "enum", T: () => ["SparkQuizStateStatusProto", SparkQuizStateStatusProto, "SPARK_QUIZ_STATE_STATUS_PROTO_"] },
            { no: 8, name: "review_status", kind: "enum", T: () => ["SparkQuizReviewStatusProto", SparkQuizReviewStatusProto, "SPARK_QUIZ_REVIEW_STATUS_PROTO_"] },
            { no: 9, name: "current_question_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 10, name: "incorrect_question_ids", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ },
    ...
    create(value?: PartialMessage<SparkQuizStateProto>): SparkQuizStateProto {
        ...
        if (value !== undefined)
            reflectionMergePartial<SparkQuizStateProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkQuizStateProto): SparkQuizStateProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* google.protobuf.Timestamp last_answered_at */ 5:
                    message.lastAnsweredAt = Timestamp.internalBinaryRead(reader, reader.uint32(), options, message.lastAnsweredAt);
                    break;
                case /* double score */ 6:
                    message.score = reader.double();
                    break;
    ...
    internalBinaryWrite(message: SparkQuizStateProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string quiz_id = 1; */
        if (message.quizId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.quizId);
        ...
        if (message.lastAnsweredAt)
            Timestamp.internalBinaryWrite(message.lastAnsweredAt, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        /* double score = 6; */
        if (message.score !== 0)
            writer.tag(6, WireType.Bit64).double(message.score);
        ...
        if (message.reviewStatus !== 0)
            writer.tag(8, WireType.Varint).int32(message.reviewStatus);
        ...
        if (message.startedAt)
            Timestamp.internalBinaryWrite(message.startedAt, writer.tag(11, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkSummarizeResponseProto$Type extends MessageType<SparkSummarizeResponseProto> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkSummarizeResponseProto): SparkSummarizeResponseProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* google.protobuf.Timestamp summarized_at */ 2:
                    message.summarizedAt = Timestamp.internalBinaryRead(reader, reader.uint32(), options, message.summarizedAt);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: SparkSummarizeResponseProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* SparkQuizSummaryProto summary = 1; */
        if (message.summary)
            SparkQuizSummaryProto.internalBinaryWrite(message.summary, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* google.protobuf.Timestamp summarized_at = 2; */
        if (message.summarizedAt)
            Timestamp.internalBinaryWrite(message.summarizedAt, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkQuizSummaryProto$Type extends MessageType<SparkQuizSummaryProto> {
    constructor() {
        super("SparkQuizSummaryProto", [
            ...
            { no: 3, name: "subject_breakdown", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => SparkSubjectSummaryProto },
            { no: 4, name: "recommendations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => SparkStudyRecommendationProto }
        ]);
    }
    create(value?: PartialMessage<SparkQuizSummaryProto>): SparkQuizSummaryProto {
        ...
        if (value !== undefined)
            reflectionMergePartial<SparkQuizSummaryProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkQuizSummaryProto): SparkQuizSummaryProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* repeated SparkSubjectSummaryProto subject_breakdown */ 3:
                    message.subjectBreakdown.push(SparkSubjectSummaryProto.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* repeated SparkStudyRecommendationProto recommendations */ 4:
                    message.recommendations.push(SparkStudyRecommendationProto.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: SparkQuizSummaryProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string quiz_id = 1; */
        if (message.quizId !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.quizId);
        /* string headline = 2; */
        ...
        for (let i = 0; i < message.subjectBreakdown.length; i++)
            SparkSubjectSummaryProto.internalBinaryWrite(message.subjectBreakdown[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* repeated SparkStudyRecommendationProto recommendations = 4; */
        for (let i = 0; i < message.recommendations.length; i++)
            SparkStudyRecommendationProto.internalBinaryWrite(message.recommendations[i], writer.tag(4, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkSubjectSummaryProto$Type extends MessageType<SparkSubjectSummaryProto> {
    constructor() {
        super("SparkSubjectSummaryProto", [
            { no: 1, name: "subject", kind: "enum", T: () => ["SparkSubjectProto", SparkSubjectProto, "SPARK_SUBJECT_PROTO_"] },
    ...
    create(value?: PartialMessage<SparkSubjectSummaryProto>): SparkSubjectSummaryProto {
        ...
        message.narrative = "";
        if (value !== undefined)
            reflectionMergePartial<SparkSubjectSummaryProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkSubjectSummaryProto): SparkSubjectSummaryProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SparkSubjectSummaryProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* SparkSubjectProto subject = 1; */
        if (message.subject !== 0)
            writer.tag(1, WireType.Varint).int32(message.subject);
        /* double mastery_percent = 2; */
        if (message.masteryPercent !== 0)
            writer.tag(2, WireType.Bit64).double(message.masteryPercent);
        /* string narrative = 3; */
        if (message.narrative !== "")
            writer.tag(3, WireType.LengthDelimited).string(message.narrative);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkStudyRecommendationProto$Type extends MessageType<SparkStudyRecommendationProto> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkStudyRecommendationProto): SparkStudyRecommendationProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SparkStudyRecommendationProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class SparkApiErrorProto$Type extends MessageType<SparkApiErrorProto> {
    constructor() {
        super("SparkApiErrorProto", [
            { no: 1, name: "code", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "message", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "details", kind: "scalar", repeat: 2 /*RepeatType.UNPACKED*/, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<SparkApiErrorProto>): SparkApiErrorProto {
        ...
        message.details = [];
        if (value !== undefined)
            reflectionMergePartial<SparkApiErrorProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkApiErrorProto): SparkApiErrorProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SparkApiErrorProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string code = 1; */
        if (message.code !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.code);
        /* string message = 2; */
...
class SparkRequestAuthProto$Type extends MessageType<SparkRequestAuthProto> {
    ...
    create(value?: PartialMessage<SparkRequestAuthProto>): SparkRequestAuthProto {
        ...
        message.userId = "";
        if (value !== undefined)
            reflectionMergePartial<SparkRequestAuthProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkRequestAuthProto): SparkRequestAuthProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SparkRequestAuthProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class SparkClientContextProto$Type extends MessageType<SparkClientContextProto> {
    ...
    create(value?: PartialMessage<SparkClientContextProto>): SparkClientContextProto {
        ...
        if (value !== undefined)
            reflectionMergePartial<SparkClientContextProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkClientContextProto): SparkClientContextProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                ...
                case /* SparkClientDeviceProto device */ 3:
                    message.device = SparkClientDeviceProto.internalBinaryRead(reader, reader.uint32(), options, message.device);
                    break;
                case /* bool beta_user */ 4:
                    message.betaUser = reader.bool();
                    break;
                case /* SparkRequestLocaleProto locale */ 5:
                    message.locale = SparkRequestLocaleProto.internalBinaryRead(reader, reader.uint32(), options, message.locale);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message: SparkClientContextProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.device)
            SparkClientDeviceProto.internalBinaryWrite(message.device, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
        /* bool beta_user = 4; */
        if (message.betaUser !== false)
            writer.tag(4, WireType.Varint).bool(message.betaUser);
        /* SparkRequestLocaleProto locale = 5; */
        if (message.locale)
            SparkRequestLocaleProto.internalBinaryWrite(message.locale, writer.tag(5, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkClientDeviceProto$Type extends MessageType<SparkClientDeviceProto> {
    ...
    create(value?: PartialMessage<SparkClientDeviceProto>): SparkClientDeviceProto {
        ...
        message.appBuild = "";
        if (value !== undefined)
            reflectionMergePartial<SparkClientDeviceProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkClientDeviceProto): SparkClientDeviceProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SparkClientDeviceProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string platform = 1; */
        if (message.platform !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.platform);
        /* string os_version = 2; */
        if (message.osVersion !== "")
            writer.tag(2, WireType.LengthDelimited).string(message.osVersion);
        /* string device_model = 3; */
        if (message.deviceModel !== "")
            writer.tag(3, WireType.LengthDelimited).string(message.deviceModel);
        /* bool is_simulator = 4; */
        if (message.isSimulator !== false)
            writer.tag(4, WireType.Varint).bool(message.isSimulator);
        /* string app_build = 5; */
        if (message.appBuild !== "")
            writer.tag(5, WireType.LengthDelimited).string(message.appBuild);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
class SparkRequestLocaleProto$Type extends MessageType<SparkRequestLocaleProto> {
    ...
    create(value?: PartialMessage<SparkRequestLocaleProto>): SparkRequestLocaleProto {
        ...
        message.timeZone = "";
        if (value !== undefined)
            reflectionMergePartial<SparkRequestLocaleProto>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SparkRequestLocaleProto): SparkRequestLocaleProto {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
    ...
    internalBinaryWrite(message: SparkRequestLocaleProto, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string language = 1; */
        if (message.language !== "")
