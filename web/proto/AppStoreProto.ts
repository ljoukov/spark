...
class AppStoreTransactionProto$Type extends MessageType<AppStoreTransactionProto> {
	constructor() {
		super('AppStoreTransactionProto', [
			...
			{ no: 10, name: 'quantity', kind: 'scalar', T: 5 /*ScalarType.INT32*/ },
			{
				...
				kind: 'enum',
				T: () => [
					'AppStorePurchaseTypeProto',
					AppStorePurchaseTypeProto,
					'APP_STORE_PURCHASE_TYPE_PROTO_'
				]
			},
			{ no: 12, name: 'app_account_token', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
			{
				...
				kind: 'enum',
				T: () => [
					'AppStoreInAppOwnershipTypeProto',
					AppStoreInAppOwnershipTypeProto,
					'APP_STORE_IN_APP_OWNERSHIP_TYPE_PROTO_'
				]
			},
			{ no: 14, name: 'signed_date', kind: 'message', T: () => Timestamp },
			{
				...
				kind: 'enum',
				T: () => [
					'AppStoreRevocationReasonProto',
					AppStoreRevocationReasonProto,
					'APP_STORE_REVOCATION_REASON_PROTO_'
				]
			},
			...
			{ no: 17, name: 'is_upgraded', kind: 'scalar', T: 8 /*ScalarType.BOOL*/ },
			{
				...
				name: 'offer_type',
				kind: 'enum',
				T: () => ['AppStoreOfferTypeProto', AppStoreOfferTypeProto, 'APP_STORE_OFFER_TYPE_PROTO_']
			},
			{ no: 19, name: 'offer_identifier', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
			{
				...
				kind: 'enum',
				T: () => [
					'AppStoreEnvironmentProto',
					AppStoreEnvironmentProto,
					'APP_STORE_ENVIRONMENT_PROTO_'
				]
			},
			...
			{ no: 22, name: 'storefront_id', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
			{
				...
				kind: 'enum',
				T: () => [
					'AppStoreTransactionReasonProto',
					AppStoreTransactionReasonProto,
					'APP_STORE_TRANSACTION_REASON_PROTO_'
				]
			},
			...
			{ no: 25, name: 'price', kind: 'scalar', T: 3 /*ScalarType.INT64*/ },
			{
				...
				kind: 'enum',
				T: () => [
					'AppStoreOfferDiscountTypeProto',
					AppStoreOfferDiscountTypeProto,
					'APP_STORE_OFFER_DISCOUNT_TYPE_PROTO_'
				]
			}
		]);
	}
	create(value?: PartialMessage<AppStoreTransactionProto>): AppStoreTransactionProto {
		...
		if (value !== undefined) reflectionMergePartial<AppStoreTransactionProto>(this, message, value);
		return message;
	}
	internalBinaryRead(
		...
		target?: AppStoreTransactionProto
	): AppStoreTransactionProto {
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* google.protobuf.Timestamp purchase_date */ 7:
					message.purchaseDate = Timestamp.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
				...
				case /* google.protobuf.Timestamp original_purchase_date */ 8:
					message.originalPurchaseDate = Timestamp.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.originalPurchaseDate
					);
					break;
				case /* google.protobuf.Timestamp expires_date */ 9:
					message.expiresDate = Timestamp.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.expiresDate
				...
				case /* google.protobuf.Timestamp signed_date */ 14:
					message.signedDate = Timestamp.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.signedDate
				...
				case /* google.protobuf.Timestamp revocation_date */ 16:
					message.revocationDate = Timestamp.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
	...
	internalBinaryWrite(
		...
		/* string bundle_id = 4; */
		if (message.bundleId !== '') writer.tag(4, WireType.LengthDelimited).string(message.bundleId);
		/* string product_id = 5; */
		if (message.productId !== '') writer.tag(5, WireType.LengthDelimited).string(message.productId);
		...
		/* int32 quantity = 10; */
		if (message.quantity !== 0) writer.tag(10, WireType.Varint).int32(message.quantity);
		...
		/* bool is_upgraded = 17; */
		if (message.isUpgraded !== false) writer.tag(17, WireType.Varint).bool(message.isUpgraded);
		/* AppStoreOfferTypeProto offer_type = 18; */
		if (message.offerType !== 0) writer.tag(18, WireType.Varint).int32(message.offerType);
		...
		if (message.environment !== 0) writer.tag(20, WireType.Varint).int32(message.environment);
		...
		/* string currency = 24; */
		if (message.currency !== '') writer.tag(24, WireType.LengthDelimited).string(message.currency);
		/* int64 price = 25; */
		if (message.price !== '0') writer.tag(25, WireType.Varint).int64(message.price);
...
class AppStoreRenewalInfoProto$Type extends MessageType<AppStoreRenewalInfoProto> {
	constructor() {
		super('AppStoreRenewalInfoProto', [
			{ no: 1, name: 'auto_renew_product_id', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
			{
				...
				kind: 'enum',
				T: () => [
					'AppStoreAutoRenewStatusProto',
					AppStoreAutoRenewStatusProto,
					'APP_STORE_AUTO_RENEW_STATUS_PROTO_'
				]
			},
			{ no: 3, name: 'currency', kind: 'scalar', T: 9 /*ScalarType.STRING*/ },
			{
				no: 4,
				name: 'eligible_win_back_offer_ids',
				kind: 'scalar',
			...
			},
			{
				...
				kind: 'enum',
				T: () => [
					'AppStoreExpirationIntentProto',
					AppStoreExpirationIntentProto,
					'APP_STORE_EXPIRATION_INTENT_PROTO_'
				]
			},
			...
			{
				no: 13,
				name: 'price_increase_status',
				kind: 'enum',
				T: () => [
					'AppStorePriceIncreaseStatusProto',
					AppStorePriceIncreaseStatusProto,
					'APP_STORE_PRICE_INCREASE_STATUS_PROTO_'
				]
			},
	...
	create(value?: PartialMessage<AppStoreRenewalInfoProto>): AppStoreRenewalInfoProto {
		...
		if (value !== undefined) reflectionMergePartial<AppStoreRenewalInfoProto>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
		length: number,
		options: BinaryReadOptions,
		target?: AppStoreRenewalInfoProto
	): AppStoreRenewalInfoProto {
		let message = target ?? this.create(),
			end = reader.pos + length;
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				...
				case /* google.protobuf.Timestamp grace_period_expires_date */ 7:
					message.gracePeriodExpiresDate = Timestamp.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.gracePeriodExpiresDate
					);
					break;
				...
				case /* google.protobuf.Timestamp recent_subscription_start_date */ 15:
					message.recentSubscriptionStartDate = Timestamp.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.recentSubscriptionStartDate
					);
					break;
				case /* google.protobuf.Timestamp renewal_date */ 16:
					message.renewalDate = Timestamp.internalBinaryRead(
						reader,
						reader.uint32(),
						options,
						message.renewalDate
	...
	internalBinaryWrite(
		...
		/* string currency = 3; */
		if (message.currency !== '') writer.tag(3, WireType.LengthDelimited).string(message.currency);
		...
		if (message.environment !== 0) writer.tag(5, WireType.Varint).int32(message.environment);
		...
		if (message.offerType !== 0) writer.tag(11, WireType.Varint).int32(message.offerType);
		...
		if (message.renewalPrice !== 0) writer.tag(17, WireType.Varint).int32(message.renewalPrice);
