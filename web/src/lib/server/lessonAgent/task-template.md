...
- Use LaTeX for maths/science formulas in quiz/coding problem Markdown (`$...$` inline, `$$...$$` display). Do not wrap `$...$` / `$$...$$` formulas in backticks (inline code); LaTeX should render as math, not `<code>`.
