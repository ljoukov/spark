...
<div class="space-y-6">
	<div class="space-y-3">
		...
		<SheetPreviewNav current="worksheet" />
	</div>

	<div class="sheet-preview-stage">
		<div class="sheet-preview-section-copy">
			<h2 class="sheet-preview-section-title">Sample worksheets</h2>
			<p class="sheet-preview-section-description">
				Swap subjects to inspect header, theory, answer rendering, and mock review placement across
				different paper shapes.
			</p>
		</div>
