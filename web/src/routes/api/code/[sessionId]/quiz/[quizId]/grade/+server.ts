...
export const POST: RequestHandler = async ({ params, request }) => {
	...
	const prompt = [
		...
		'2) "Grading scheme:" followed by bullet points describing how marks are awarded for this specific question (one bullet per mark or mark cluster).',
		...
		'Example: {"awardedMarks":2,"feedback":"Full marks answer: **Antibiotics** target bacteria, not viruses, so **painkillers** treat symptoms; recovery depends on **immune response**.\\n\\nGrading scheme:\\n- 1 mark: States antibiotics do not work on viruses.\\n- 1 mark: Mentions immune system clearing infection (antibodies/phagocytosis).\\n- 1 mark: Mentions painkillers relieve symptoms (not pathogens).\\n- 1 mark: Explains why recovery is delayed/relies on immune cells.\\n\\nVerdict: You mentioned X, but missed Y and Z."}',
