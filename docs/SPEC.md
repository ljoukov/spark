...
- Grading prompt: strict rubric enforcement with partial credit; return JSON with `awardedMarks` and concise `feedback`, and categorize as {correct, partial, incorrect} for UI tone/summary.
