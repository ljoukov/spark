...
- Spark is an effort comprising two apps:
  ...
  - Spark AI Agent (web, Phase 1)
    ...
    - Assistant output renders markdown via Textual (including LaTeX + code blocks).
