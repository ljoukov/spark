...
extension AppStoreInAppOwnershipTypeProto: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0APP_STORE_IN_APP_OWNERSHIP_TYPE_PROTO_UNSPECIFIED\0\u{1}APP_STORE_IN_APP_OWNERSHIP_TYPE_PROTO_PURCHASED\0\u{1}APP_STORE_IN_APP_OWNERSHIP_TYPE_PROTO_FAMILY_SHARED\0")
}

extension AppStoreRevocationReasonProto: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0APP_STORE_REVOCATION_REASON_PROTO_UNSPECIFIED\0\u{1}APP_STORE_REVOCATION_REASON_PROTO_REFUNDED_FOR_OTHER_REASON\0\u{1}APP_STORE_REVOCATION_REASON_PROTO_REFUNDED_DUE_TO_ISSUE\0")
}
...
extension AppStoreEnvironmentProto: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0APP_STORE_ENVIRONMENT_PROTO_UNSPECIFIED\0\u{1}APP_STORE_ENVIRONMENT_PROTO_SANDBOX\0\u{1}APP_STORE_ENVIRONMENT_PROTO_PRODUCTION\0\u{1}APP_STORE_ENVIRONMENT_PROTO_XCODE\0\u{1}APP_STORE_ENVIRONMENT_PROTO_LOCAL_TESTING\0")
}

extension AppStoreTransactionReasonProto: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0APP_STORE_TRANSACTION_REASON_PROTO_UNSPECIFIED\0\u{1}APP_STORE_TRANSACTION_REASON_PROTO_PURCHASE\0\u{1}APP_STORE_TRANSACTION_REASON_PROTO_RENEWAL\0")
}

extension AppStoreOfferDiscountTypeProto: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0APP_STORE_OFFER_DISCOUNT_TYPE_PROTO_UNSPECIFIED\0\u{1}APP_STORE_OFFER_DISCOUNT_TYPE_PROTO_FREE_TRIAL\0\u{1}APP_STORE_OFFER_DISCOUNT_TYPE_PROTO_PAY_AS_YOU_GO\0\u{1}APP_STORE_OFFER_DISCOUNT_TYPE_PROTO_PAY_UP_FRONT\0")
}

extension AppStoreAutoRenewStatusProto: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0APP_STORE_AUTO_RENEW_STATUS_PROTO_UNSPECIFIED\0\u{1}APP_STORE_AUTO_RENEW_STATUS_PROTO_OFF\0\u{1}APP_STORE_AUTO_RENEW_STATUS_PROTO_ACTIVE\0")
}
...
extension AppStorePriceIncreaseStatusProto: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0APP_STORE_PRICE_INCREASE_STATUS_PROTO_UNSPECIFIED\0\u{1}APP_STORE_PRICE_INCREASE_STATUS_PROTO_PENDING_RESPONSE\0\u{1}APP_STORE_PRICE_INCREASE_STATUS_PROTO_CONSENTED\0")
}
