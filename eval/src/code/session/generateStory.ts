...
export function buildSegmentationPrompt(
  ...
  return [
    ...
    "14. Match the narration’s meaning, not isolated keywords. Interpret metaphors, idioms, or symbolic phrases sensibly and depict the actual historical situation being described. Never turn figurative language (e.g., “cornerstone”) into literal objects unless the story explicitly establishes them.",
    "15. Each segment must present a distinct scene or setting that moves the story forward. Do not request minor variations of a prior panel (e.g., slightly different poses or gestures); change the environment, composition, or moment meaningfully while staying consistent with the characters and timeline.",
    "",
    "================ Story to segment ================",
    storyText,
    "==================================================",
