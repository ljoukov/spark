...
- default model: `chatgpt-gpt-5.6-sol`
...
```bash
bun --cwd=eval run bench:pdf-transcription-agentic -- --models=chatgpt-gpt-5.6-sol,chatgpt-gpt-5.3-codex-spark,gemini-2.5-pro,gemini-flash-latest
```
