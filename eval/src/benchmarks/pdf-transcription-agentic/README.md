...
- default model: `chatgpt-gpt-5.5-fast`
...
```bash
bun --cwd=eval run bench:pdf-transcription-agentic -- --models=chatgpt-gpt-5.5-fast,chatgpt-gpt-5.3-codex-spark,gemini-2.5-pro,gemini-flash-latest
```
